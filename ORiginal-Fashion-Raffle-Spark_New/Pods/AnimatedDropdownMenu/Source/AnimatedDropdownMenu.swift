...
public class AnimatedDropdownMenu: UIView {
    ...
    public init(navigationController: UINavigationController!, containerView: UIView!, selectedIndex: Int!, items: [Item]!) {
        ...
        //Get titleSize
        let titleSize = (title as NSString).size(withAttributes: [NSAttributedStringKey.font: dropdownConfig.menuTitleFont])
    ...
    fileprivate func setupDefaultConfiguration() {
        ...
        menuTitleColor = navigationController?.navigationBar.titleTextAttributes?[NSAttributedStringKey.foregroundColor] as? UIColor
