    ...
    @IBAction func flipButtonPressed(_ sender: UIButton) {
        ...
        do {
            ...
            if let session = session {
                ...
                let position = (videoInput?.device.position == AVCaptureDevice.Position.front) ? AVCaptureDevicePosition.back : AVCaptureDevicePosition.front

                for device in AVCaptureDevice.devices(for: AVMediaTypeVideo) {
    ...
    @IBAction func flashButtonPressed(_ sender: UIButton) {
        ...
        do {
            ...
            if let device = device {
                ...
                if mode == AVCaptureDevice.FlashModeAVCaptureDevice.FlashMode.off {
